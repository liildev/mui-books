    ...
    <>
      ...
      {isLoading ? (
        ...
        <Box sx={{ textAlign: 'center' }}>
          <Typography variant="h5">Start searching for your favorite books!</Typography>
          <Typography variant="body2">Use the search bar above to find books by title</Typography>
        </Box>
      ) : data && data.length > 0 ? (
        ...
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Typography variant="body2">
            {error?.message || "We couldn't find any books matching your search. Please try a different query"}
          </Typography>
        </Box>
      )}
    </>
